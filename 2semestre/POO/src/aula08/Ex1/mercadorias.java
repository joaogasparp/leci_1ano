...
public class mercadorias extends empresa {
    ...
    public mercadorias(String nomeE, int codigoP, String email, String matricula, String marca, String modelo, int potencia, int numQuadro, int peso, int cargaM) {
