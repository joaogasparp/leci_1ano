...
-- Equation(s):
-- \LEDR~0_combout\ = (\KEY[0]~input_o\ & (((\SW[1]~input_o\) # (\KEY[1]~input_o\)))) # (!\KEY[0]~input_o\ & (\SW[0]~input_o\ & ((!\KEY[1]~input_o\))))
...
-- Equation(s):
-- \LEDR~1_combout\ = (\LEDR~0_combout\ & ((\SW[3]~input_o\) # ((!\KEY[1]~input_o\)))) # (!\LEDR~0_combout\ & (((\SW[2]~input_o\ & \KEY[1]~input_o\))))
