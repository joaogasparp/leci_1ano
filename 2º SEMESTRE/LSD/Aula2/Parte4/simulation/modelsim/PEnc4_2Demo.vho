...
SIGNAL \inst|encodedOut[0]~0_combout\ : std_logic;
...
-- Equation(s):
-- \inst|Equal0~0_combout\ = (!\SW[3]~input_o\ & (!\SW[1]~input_o\ & (!\SW[0]~input_o\ & !\SW[2]~input_o\)))
...
-- Equation(s):
-- \inst|Equal0~1_combout\ = (!\SW[2]~input_o\ & !\SW[3]~input_o\)
...
-- Equation(s):
-- \inst|encodedOut\(1) = (GLOBAL(\inst|Equal0~0clkctrl_outclk\) & ((\inst|encodedOut\(1)))) # (!GLOBAL(\inst|Equal0~0clkctrl_outclk\) & (!\inst|Equal0~1_combout\))
...
PORT MAP (
	...
	datac => \inst|encodedOut\(1),
	datad => \inst|Equal0~0clkctrl_outclk\,
	combout => \inst|encodedOut\(1));

-- Location: LCCOMB_X114_Y30_N26
\inst|encodedOut[0]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|encodedOut[0]~0_combout\ = (\SW[3]~input_o\) # ((!\SW[2]~input_o\ & \SW[1]~input_o\))
...
PORT MAP (
	...
	datab => \SW[1]~input_o\,
	datac => \SW[3]~input_o\,
	combout => \inst|encodedOut[0]~0_combout\);

-- Location: LCCOMB_X97_Y30_N8
\inst|encodedOut[0]\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|encodedOut\(0) = (GLOBAL(\inst|Equal0~0clkctrl_outclk\) & ((\inst|encodedOut\(0)))) # (!GLOBAL(\inst|Equal0~0clkctrl_outclk\) & (\inst|encodedOut[0]~0_combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \inst|encodedOut[0]~0_combout\,
	datac => \inst|encodedOut\(0),
	datad => \inst|Equal0~0clkctrl_outclk\,
